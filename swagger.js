export default {
  ...
  paths: {
    ...
    '/admin/authors/:username': {
      put: {
        tags: ['Featured Author'],
        consumes: ['application/x-www-form-urlencoded'],
        summary: 'Set author of the week',
        parameters: [
          {
            name: 'username',
            in: 'path',
        ...
        responses: {
          200: {
            description: 'Successfully set author of the week.',
          },
          404: {
    ...
    '/authors/featured': {
      get: {
        tags: ['Featured Author'],
        summary: 'Get author of the week',
        consumes: ['application/x-www-form-urlencoded'],
        responses: {
          200: {
            description: 'Author of the week retrieved.',
          },
        }
      },
    },
